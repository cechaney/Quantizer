...
public class HTMLColors {
    ...
    /**
     * map between color names and colors; tough there are fields for every
     * color we use a map because is a faster way to get the color
     */
    private static Map<String, Color> name2color = new HashMap<String, Color>();
    /**
     * map between colors and color names; tough there are fields for every
     * color we use a map because is a faster way to get the color
     */
